#!/usr/bin/env python3
"""
framefetch.py — v11 Framework physical hardware dashboard for the Framework 13 ASCII dashboard.
...
def render(s: Snapshot) -> str:
    ...
    lines.append(
        f"│{portline(1,2)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[0], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"│{fit(dline2,16)}│    "
    ...
    lines.append(
        f"│{portline(1,3)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[1], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"└────────────────┘    "
    ...
    lines.append(
        f"│{portline(1,4)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[2], LOGO_SHIFT_RIGHT, 35), LOGO)}│                         "
    ...
    lines.append(
        f"│{portline(1,5)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[3], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"┌─────────────────┐   "
    ...
    lines.append(
        "└───────────────┘  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[4], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"│ {fit(cpu_name,15)} │   "
    ...
    lines.append(
        "                   │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[5], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"│ {fit('',15)} │   "
    ...
    lines.append(
        "┌────PORT─2─────┐  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[6], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
    ...
    lines.append(
        f"│{portline(2,0)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[7], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"│{fit('',17)}│   "
    ...
    lines.append(
        f"│{portline(2,1)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[8], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"│ {fit(gpu_name,15)} │   "
        f"│{fit('',10)}│  │{fit('',10)}│   │ "
        f"│{portline(4,1)}│"
    )
    ...
    lines.append(
        f"│{portline(2,2)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[9], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
    ...
    lines.append(
        f"│{portline(2,3)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[10], LOGO_SHIFT_RIGHT, 35), LOGO)}│   "
        f"└─────────────────┘   "
        f"│{fit('',10)}│  │{fit('',10)}│   │ "
        f"│{portline(4,3)}│"
    )
    ...
    lines.append(
        f"│{portline(2,4)}│  │"
        f"         │{ansi(shift_ascii_line(FW_LOGO[11], LOGO_SHIFT_RIGHT, 35), LOGO)}│                         "
        f"└──────────┘  └──────────┘   │ "
        f"│{portline(4,4)}│"
    )
